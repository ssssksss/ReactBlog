...
function Sidemenulist(props) {
  ...
  function Sidemenu(props) {
    return (
      <a href="#" className="menu-item" onClick={() => props.goToMenu && setActiveMenu(props.goToMenu)}>
        <div className="each_menu_container">{props.children}</div>
      </a>
    )
  }
  ...
  return (
    <div className="side_menu_list">
      ...
      <CSSTransition in={activeMenu === "main"} timeout={500} classNames="menu-first" unmountOnExit onEnter={() => setActiveMenu("main")}>
      ...
      <CSSTransition in={activeMenu === "makemenu"} timeout={500} classNames="menu-second" unmountOnExit onEnter={() => setActiveMenu("makemenu")}>
        <div className="menu menu2">
      ...
      <CSSTransition in={activeMenu === "html"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("html")}>
      ...
      <CSSTransition in={activeMenu === "css"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("css")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "javascript"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("javascript")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "typescript"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("typescript")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "react"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("react")}>
        <div className="menu menu3">
      ...
      {/* 세번째 메뉴 - 백 엔드 ========================================================= */}
      <CSSTransition in={activeMenu === "java"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("java")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "jsp"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("jsp")}>
        <div className="menu menu3">
          ...
          <Sidemenu>
            <a
              href="#"
              onClick={() => {
                send("jsp_bulletin_board")
              }}>
              JSP 게시판 만들기 👉
            </a>
          </Sidemenu>
          {/* <Sidemenu goToMenu="backendmenu">  </Sidemenu> */}
        </div>
      </CSSTransition>

      <CSSTransition in={activeMenu === "php"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("php")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "nodejs"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("nodejs")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "oracledb"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("oracledb")}>
        <div className="menu menu3">
      ...
      <CSSTransition in={activeMenu === "mysql"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("mysql")}>
        <div className="menu menu3">
      ...
      {/* 세번째 메뉴 - 디자인 ========================================================= */}
      <CSSTransition in={activeMenu === "design"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("design")}>
        <div className="menu menu3">
      ...
      {/* 세번째 메뉴 - 네트워크 및 시스템 ========================================================= */}
      <CSSTransition in={activeMenu === "server"} timeout={500} classNames="menu-third" unmountOnExit onEnter={() => setActiveMenu("server")}>
        <div className="menu menu3">
          <Sidemenu goToMenu="backendmenu"> Network </Sidemenu>
          <Sidemenu>
            {" "}
