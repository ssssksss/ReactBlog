...
const Jsp2 = () => {
  ...
  return (
    <div className="page_container">
      ...
      <br /> <p className="stitle"> (4) 이클립스 와 OracleDB 연결하기 </p>
      <div className="content_container">
...
public class Test2 {
    public static void main(String[] args) {
      ...
      <br /> <p className="stitle"> (5) JSP파일 실행해보기 </p>
      <div className="content_container">
...
<body>
	<p>동작완료</p>
        ...
        <ImageSlider image={(arr = ["/img/jsp2/jsp2_5_", "2", ".png"])}> </ImageSlider> <br />
      </div>
      <p stitle="6) Servlet 사용하기" content="이클립스에서 Servlet파일 생성" />
      <br /> <p className="stitle"> (6)) Servlet파일 실행해보기 </p>
      <div className="content_container">
        <p> Servlet은 코드를 작성하기 번거로우나 JSP파일은 Servlet으로 변환이 되므로 개발자는 알아두어야 한다. </p>
        <ImageSlider image={(arr = ["/img/jsp2/jsp2_6_", "5", ".png"])}> </ImageSlider> <br />
      </div>
      <br /> <p className="stitle"> (7) JSP 코드 작성 및 문법이해 </p>
      <div className="content_container">
        <p> JSP문법</p>
...
'
        ...
        <ImageSlider image={(arr = ["/img/jsp2/jsp2_8_", "2", ".png"])}> </ImageSlider> <br />
      </div>
